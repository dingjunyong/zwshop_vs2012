    ...
    public partial class CommonHelper
    {
            ...
            string valueName, bool defaultValue)
        {
            ...
            if (!bool.TryParse(str1, out result))
                throw new ShopException(string.Format("Value must be boolean {0}", valueName));
            return result;
        }
            ...
            string valueName, int defaultValue, bool zeroAllowed, int maxValueAllowed)
        {
            ...
            if (!int.TryParse(str1, out result))
            {
                if (zeroAllowed)
                {
                    throw new ShopException(string.Format("Value must be non negative integer {0}", valueName));
                }
                throw new ShopException(string.Format("Value must be positive integer {0}", valueName));
            }
            ...
            if ((maxValueAllowed > 0) && (result > maxValueAllowed))
                throw new ShopException(string.Format("Value too big {0}", valueName));
            return result;
        }
