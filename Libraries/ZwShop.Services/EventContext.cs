    ...
    public partial class EventContext
    {
        ...
        public static EventContext Current
        {
            get
            {
                ...
                {
                    object data = Thread.GetData(Thread.GetNamedDataSlot("ShopEventContext"));
                    if (data != null)
                    {
                        return (EventContext)data;
                    }
                    EventContext context = new EventContext();
                    Thread.SetData(Thread.GetNamedDataSlot("ShopEventContext"), context);
                    return context;
                }
                if (HttpContext.Current.Items["ShopEventContext"] == null)
                {
                    EventContext context = new EventContext();
                    HttpContext.Current.Items.Add("ShopEventContext", context);
                    return context;
                }
                return (EventContext)HttpContext.Current.Items["ShopEventContext"];
            }
        }
