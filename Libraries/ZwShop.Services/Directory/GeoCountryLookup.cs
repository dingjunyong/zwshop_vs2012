...
{
    public partial class GeoCountryLookup
    {
        #region Fields
        ...
        private static long addrToNum(IPAddress addr)
        {
            long ipnum = 0;
        ...
        private static long seekCountry(long offset, long ipnum, int depth)
        {
            ...
            try
            {
                ...
                {
                    fileName = String.Format("{0}files\\GeoIP.dat", HttpContext.Current.Request.PhysicalApplicationPath);
                }
        ...
        public static string LookupCountryCode(IPAddress addr)
        {
        ...
        public static string LookupCountryName(string str)
        {
            if (String.IsNullOrEmpty(str))
                return string.Empty;
        ...
        public static string LookupCountryName(IPAddress addr)
        {
