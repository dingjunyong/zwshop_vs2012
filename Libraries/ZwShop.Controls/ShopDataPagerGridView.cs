...
namespace ZwShop.Controls
{
    ...
    /// </summary>
    public partial class ShopDataPagerGridView : GridView, IPageableItemContainer
    {
        /// <summary>
        /// Ctor for ShopDataPagerGridView
        /// </summary>
        public ShopDataPagerGridView()
            : base()
        {
        ...
        {
            add { base.Events.AddHandler(ShopDataPagerGridView.EventTotalRowCountAvailable, value); }
            remove { base.Events.RemoveHandler(ShopDataPagerGridView.EventTotalRowCountAvailable, value); }
        }
